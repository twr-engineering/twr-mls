...
/**
 * Barangay select field for the Developments collection.
 * Fetches barangays from PSGC API based on the selected city.
 * Provides a searchable dropdown that cascades from city selection.
 */
export const DevelopmentBarangaySelectField: React.FC<Props> = ({ path, field }) => {
...
export default DevelopmentBarangaySelectField
